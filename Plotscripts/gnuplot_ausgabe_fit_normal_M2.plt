...
plot f(x), "../Output_Normed/histogram_N50_M2.dat" title 'n=50'
f(x) = 1/((2*pi*std**2)**0.5) * exp(-(x-nu)**2/(2*std**2))
std = 55
nu =1
fit f(x) "../Output_Normed/histogram_N100_M2.dat" via std, nu
plot f(x), "../Output_Normed/histogram_N100_M2.dat" title 'n=100'
f(x) = 1/((2*pi*std**2)**0.5) * exp(-(x-nu)**2/(2*std**2))
std = 50
nu = 6
fit f(x) "../Output_Normed/histogram_N200_M2.dat" via std, nu
plot f(x), "../Output_Normed/histogram_N200_M2.dat" title 'n=200'
f(x) = 1/((2*pi*std**2)**0.5) * exp(-(x-nu)**2/(2*std**2))
std = 50
nu = 6
fit f(x) "../Output_Normed/histogram_N400_M2.dat" via std, nu
plot f(x), "../Output_Normed/histogram_N400_M2.dat" title 'n=400'
