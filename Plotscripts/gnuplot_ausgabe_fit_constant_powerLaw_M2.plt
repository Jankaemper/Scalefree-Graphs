...
plot h(x) title "", "Output_constant/histogram_N50_M2_k0.500000.dat" using 1:3:5 with yerrorbars title ""
i(x) = k_4 * (C_4/x)**(l_4*x)
k_4=1.1
l_4=1.2
C_4=13.1
...
plot i(x) title "", "Output_constant/histogram_N50_M2_k0.500000.dat" using 1:3:5 with yerrorbars title ""
